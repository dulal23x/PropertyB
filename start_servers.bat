...
start "Backend Server" cmd /c "cd /d app\backend && set DATABASE_URL=sqlite+aiosqlite:///./realestate_mvp_v1.db&& set EMAIL_PROVIDER=console&& set REAL_ESTATE_PUBLIC_PHONE=+8801712345678&& python -m uvicorn app.main:app --host 127.0.0.1 --port 8090"
