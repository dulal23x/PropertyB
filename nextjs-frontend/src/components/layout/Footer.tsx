      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12 grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-10 lg:grid-cols-6 lg:gap-8">
          <div className="order-last flex flex-col items-center text-center md:order-none md:col-span-2 md:items-start md:text-left lg:col-span-1">
            <Link href="/" aria-label="PropertyBikri home" className="inline-flex">
              <Image
          ...
          <div className="text-left">
            ...
            <ul className="space-y-3 text-sm font-medium text-gray-800">
              <li><Link href="/properties?purpose=sale&property_type=land&area_name=Purbachal" className="transition-colors hover:text-brand-green">Land for sale in Purbachal</Link></li>
              <li><Link href="/properties?purpose=sale&property_type=land&area_name=Bashundhara" className="transition-colors hover:text-brand-green">Land for sale in Bashundhara</Link></li>
              <li><Link href="/properties?purpose=sale&property_type=land&area_name=Uttara" className="transition-colors hover:text-brand-green">Land for sale in Uttara</Link></li>
              <li><Link href="/properties?purpose=sale&property_type=land&area_name=Baridhara" className="transition-colors hover:text-brand-green">Land for sale in Baridhara</Link></li>
            </ul>
          </div>
          <div className="text-left">
            ...
            <ul className="space-y-3 text-sm font-medium text-gray-800">
              <li><Link href="/properties?purpose=sale&property_type=house&area_name=Gulshan" className="transition-colors hover:text-brand-green">House for sale in Gulshan</Link></li>
              <li><Link href="/properties?purpose=sale&property_type=house&area_name=Banani" className="transition-colors hover:text-brand-green">House for sale in Banani</Link></li>
              <li><Link href="/properties?purpose=sale&property_type=house&area_name=Dhanmondi" className="transition-colors hover:text-brand-green">House for sale in Dhanmondi</Link></li>
              <li><Link href="/properties?purpose=sale&property_type=house&area_name=Uttara" className="transition-colors hover:text-brand-green">House for sale in Uttara</Link></li>
            </ul>
          </div>
          <div className="text-left">
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-gray-300 pt-8 text-center text-xs font-bold uppercase tracking-widest text-gray-700 md:flex-row md:text-left">
          <p>
            ...
            <Link href="/" className="hover:text-brand-green">PropertyBikri</Link>, a concern of{" "}
