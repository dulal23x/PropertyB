          ...
          <aside className="w-full lg:w-1/3 space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-brand-border sticky top-24">
              ...
              <div className="space-y-4 mb-6">
                <a href={`tel:${businessPhone}`} className="w-full flex items-center justify-center gap-2 bg-brand-green text-white font-bold py-3 rounded-md hover:bg-brand-greenHover transition-colors">
